...
public class CasualRaw extends AppCompatActivity {
    Button btnAryan,btntundey,btngnpti,btnlazeez,btnYadav,btnbaluchi,btnpizza,btnfoodywoody,btnKalewa,btnfoodhut;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_casual_raw);
        ...
        btnAryan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(CasualRaw.this, casualmore.class);
                in.putExtras(b);
