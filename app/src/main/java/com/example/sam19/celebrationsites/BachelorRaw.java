...
public class BachelorRaw extends AppCompatActivity {
 Button btnknock,btnangara,btnbigdady,btnhokup,btntramptree,btnhashttag,btnjail,btnMile;
       ...
       btnhokup=(Button)findViewById(R.id.btnhookup);
        ...
        btnknock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(BachelorRaw.this, BachelorMoreDetails.class);
                in.putExtras(b);
